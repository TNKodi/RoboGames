...
def part2():
    ...
    global red_curr_path
    global red_curr_index
    current_path=red_curr_path
    color_path_index=red_curr_index
    stop()
    if(current_path[curr_index]==0):
        print(22222)
        print(color_path_index,curr_index,1111111111111111111111111)
        if (color_path_index==3 and curr_index==4):
            forward()
            delay(3.4)
            stop()
            turn(2)
            ...
            stop()
            curr_index+=1
        if (color_path_index==3 and curr_index==15):
            forward()
            delay(3.14)
            stop()
            curr_index+=1
        if (color_path_index==2 and curr_index==1):
            forward()
            delay(3.14)
            stop()
            curr_index+=1
